...
public class AccountServiceTests
{
    ...
    public async Task AddAccount_CommonWay_ShouldEncryptAccountAndAddToRepo()
    {
        ...
        var encryptedItem = new EncryptedItem() { Name = account.Name, Data = new() { Data = [], Salt = [] } };
        var expectedId = 123;
    ...
    public async Task UpdateAccount_CommonWay_ShouldEncryptAccountAndUpdateInRepo()
    {
        ...
        var expectedItem = new EncryptedItem
        {
            Id = account.Id,
            Name = account.Name,
            Data = new EncryptedData() { Data = [], Salt = [] }
        };
    ...
    public async Task GetAccountById_CommonWay_ShouldGetDataFromRepoAndDecrypt()
    {
        ...
        var item = new EncryptedItem() { Id = 123, Name = "name", Data = new() };
        ...
        _storageMock
            ...
            .Returns(key);
        _cryptoMock
            .Setup(m => m.DecryptJson<AccountData>(item.Data, key))
        ...
        _storageMock.Verify(m => m.Key, Times.Once);
        _cryptoMock.Verify(m => m.DecryptJson<AccountData>(item.Data, key), Times.Once);
    ...
    private static bool CheckItem(EncryptedItem actual, EncryptedItem expected)
    {
        return actual.Id == expected.Id
            ...
            && actual.Data.Data.SequenceEqual(expected.Data.Data)
            && actual.Data.Salt.SequenceEqual(expected.Data.Salt);
    }
}
